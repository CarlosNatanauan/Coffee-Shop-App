...
class DrinkCategoryNotifier extends StateNotifier<List<DrinkCategory>> {
  ...
  Future<void> fetchCategories() async {
    try {
      final data = await _apiService.getCategoriesDrinks();
  ...
  Future<DrinkCategory?> fetchCategoryById(String documentId) async {
    try {
      final data = await _apiService.getCategoryByIdDrinks(documentId);
  ...
  Future<void> addCategory(String categoryName) async {
    try {
      final data = await _apiService.addCategoryDrinks(categoryName);
      final newCategory =
  ...
  Future<void> updateCategory(String documentId, String newCategoryName) async {
    try {
      ...
      final updatedData = await _apiService.updateCategoryDrinks(documentId, {
        'data': {
  ...
  Future<void> deleteCategory(String documentId) async {
    try {
      await _apiService.deleteCategoryDrinks(documentId);
      state =
